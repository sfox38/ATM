...
export const PERSONAS: PersonaDef[] = [
  ...
  },
  {
    ...
    description: "Reads and discovers entities and builds Lovelace dashboards. Filesystem access (theme and custom-card assets) requires confirmation. No device control or config authoring.",
  },
  {
    key: "maintenance",
    label: "Maintenance / backups",
    description: "Full reads and diagnostics, creates backups. Restart and entity-registry edits (name, area, delete stale entries) require confirmation. No device control, config authoring, or dashboards.",
  },
  {
  ...
  },
  {
    key: "power_user",
    label: "Power user",
    description: "Full reads and config writes, restart allowed. Physical actions, integrations, dashboards, backups, and entity-registry edits require confirmation; filesystem and raw YAML stay off.",
  },
  {
    key: "home_admin",
    label: "Home administrator",
    description: "Whole-home control with a safety net. All reads and config writes; restart, physical actions, integrations, dashboards, backups, entity-registry edits, filesystem, and raw YAML all require admin confirmation.",
  },
  {
    key: "new_user",
    label: "New user",
