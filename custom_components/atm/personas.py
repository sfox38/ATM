...
PERSONA_DESCRIPTIONS: dict[str, str] = {
    ...
    PERSONA_POWER_USER: "Trusted operator. Full reads and config writes, restart allowed. Physical actions, integration toggles, dashboards, and backups require confirmation; filesystem and raw YAML stay off.",
    PERSONA_HOME_ADMIN: "Whole-home administrator with a safety net. All reads and config writes allowed; restart, physical actions, integrations, dashboards, backups, filesystem, and raw YAML all require admin confirmation.",
    PERSONA_DASHBOARD_DESIGNER: "Dashboard builder. Reads and discovers entities and creates, edits, and deletes Lovelace dashboards; filesystem access (theme and custom-card assets) requires confirmation. No device control or config authoring.",
    PERSONA_MAINTENANCE: "Upkeep and backups. Full reads and diagnostics, creates backups, restart requires confirmation. No device control, config authoring, or dashboards.",
